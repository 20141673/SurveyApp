...
public class EleQActivity extends AppCompatActivity {
    private static final String[] strs=new String[]{
            "No","Yes,HSK4","Yes,HSK5","Yes,HSK6"
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ele_q);
        ...
        lv01.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                result01=getString(R.string.qustion11)+strs[position];
                setTitle(result01);
                isSelected = 1;
            }
        });
        ...
        btn01.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(isSelected==1) {
                    ...
                    Intent intent = new Intent(EleQActivity.this, TwlQActivity.class);
                    EleQActivity.this.startActivity(intent);
                }else {
                    Toast.makeText(EleQActivity.this,"Please make a selection",Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
