...
public class TenQActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ten_q);
        ...
        lv01.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                result01=getString(R.string.qustion10)+strs[position];
                setTitle(result01);
                isSelected = 1;
            }
        });
        ...
        btn01.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(isSelected==1) {
                    ...
                    Intent intent = new Intent(TenQActivity.this, EleQActivity.class);
                    TenQActivity.this.startActivity(intent);
                }else {
                    Toast.makeText(TenQActivity.this,"Please make a selection",Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
