...
public class SevenQActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seven_q);
        ...
        lv01.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                result01=getString(R.string.qustion7)+strs[position];
                setTitle(result01);
                isSelected = 1;
            }
        });
        ...
        btn01.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(isSelected==1) {
                    ...
                    Intent intent = new Intent(SevenQActivity.this, EightQActivity.class);
                    SevenQActivity.this.startActivity(intent);
                }else {
                    Toast.makeText(SevenQActivity.this,"Please make a selection",Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
