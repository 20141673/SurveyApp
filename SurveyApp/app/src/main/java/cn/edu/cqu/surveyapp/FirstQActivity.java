...
public class FirstQActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lv01.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                result01=getString(R.string.qustion1)+strs[position];
                setTitle(result01);
                isSelected = 1;
            }
        });
        ...
        btn01.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(isSelected==1) {
                    ...
                    Intent intent = new Intent(FirstQActivity.this, SecondQActivity.class);
                    FirstQActivity.this.startActivity(intent);
                }else{
                    Toast.makeText(FirstQActivity.this,"Please make a selection",Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
