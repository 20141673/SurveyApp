...
public class FourthQActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fourth_q);
        ...
        lv01.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                result01=getString(R.string.qustion4)+strs[position];
                setTitle(result01);
                isSelected = 1;
            }
        });
        ...
        btn01.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(isSelected==1) {
                    ...
                    Intent intent = new Intent(FourthQActivity.this, FifthQActivity.class);
                    FourthQActivity.this.startActivity(intent);
                }else {
                    Toast.makeText(FourthQActivity.this,"Please make a selection",Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
